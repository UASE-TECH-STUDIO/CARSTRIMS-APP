...
export default function UserTopbar() {
  ...
  return (
    <header className="user-topbar">
      ...
      <style>{`
        .user-topbar{height:calc(56px + var(--sat, 0px));background:var(--surface);border-bottom:1px solid var(--border);display:flex;align-items:center;justify-content:space-between;padding:0 1.5rem;padding-top:var(--sat, 0px);position:sticky;top:0;z-index:50}
