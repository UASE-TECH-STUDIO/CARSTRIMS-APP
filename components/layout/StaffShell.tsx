...
const PAGE_TITLES: Record<string,string> = {
  ...
  "/dashboard/staff/id-cards": "ID Cards",
  "/dashboard/staff/business-docs": "Business Documents",
  "/dashboard/staff/marketing": "Marketing Materials",
...
const ALL_NAV = [
  ...
  { href:"/dashboard/staff/id-cards",       label:"ID Cards",         icon:"", perm:"generate_id_cards" },
  { href:"/dashboard/staff/business-docs",  label:"Business Documents", icon:"", perm:"generate_business_docs" },
  { href:"/dashboard/staff/marketing",      label:"Marketing Materials", icon:"", perm:"generate_marketing_materials" },
  ...
  return (
    <div className="staff-shell">
      ...
      <style>{`
        ...
        .staff-topbar{height:calc(64px + var(--sat, 0px));background:#fff;border-bottom:1.5px solid #E5E5E5;display:flex;align-items:center;justify-content:space-between;padding:0 1.75rem;padding-top:var(--sat, 0px);position:sticky;top:0;z-index:50;box-shadow:0 1px 4px rgba(0,0,0,0.06);flex-shrink:0;gap:1rem}
