    ...
    <div className="car-detail">
      <header className="detail-topbar">
        ...
        <div className="topbar-actions">
          ...
          {isAdmin && (
            <button className="action-btn admin-del" onClick={handleAdminDeleteCar}>🗑 Delete</button>
          )}
        </div>
      </header>
      ...
      <div className="detail-body">
        ...
        <div className="gallery">
          ...
          {/* Thumbnails — always horizontal scroll, fixed height, never overflows */}
          {car.images?.length > 1 && (
          ...
          {car.video && (
            <div className="video-section">
              <video src={car.video} controls className="car-video"/>
            </div>
          )}
        </div>
                ...
                <div className="contact-section">
                  ...
                  {showContact && (
                    <div className="contact-buttons">
                      ...
                      {car.dealer.email && (
                        <a href={`mailto:${car.dealer.email}`} className="cta-btn email">✉ Email</a>
                      )}
                    </div>
                  )}
                </div>
        ...
        {isAuthenticated ? (
          <form onSubmit={handleComment} className="comment-form">
            ...
            <div className="comment-input-wrap">
              <textarea className="comment-input" placeholder="Write a comment..." value={commentText}
          ...
          {comments.length === 0 ? (
            ...
            <div key={c._id} className="comment-item">
              ...
              <div className="comment-content">
                ...
                {isAuthenticated && (
                  <button className="reply-btn" onClick={() => setReplyTo(replyTo===c.commentId?null:c.commentId)}>
                    Reply
                  </button>
                )}
                {replyTo === c.commentId && (
      ...
      <style>{`
        ...
        .back-btn{background:none;border:none;color:#737373;font-size:0.875rem;cursor:pointer;font-family:var(--font-body);flex-shrink:0}
        ...
        .action-btn.admin-del{color:#DC2626;border-color:rgba(220,38,38,0.3)}
        .action-btn.admin-del:hover{background:#FEF2F2;border-color:#DC2626}
        ...
        /* KEY FIX: aspect-ratio on desktop, fixed height on mobile — never overflows */
        ...
        .img-arrow{position:absolute;top:50%;transform:translateY(-50%);background:rgba(0,0,0,0.4);color:#fff;border:none;border-radius:50%;width:36px;height:36px;font-size:1.4rem;cursor:pointer;display:flex;align-items:center;justify-content:center;z-index:2;transition:background 0.2s}
        ...
        /* Thumbnails — horizontal scroll, fixed size, never stacks or overflows */
        ...
        .contact-toggle{background:#FFF7ED;border:1.5px solid rgba(244,123,32,0.3);color:#C4621A;border-radius:8px;padding:0.7rem;font-family:var(--font-body);font-size:0.875rem;cursor:pointer;transition:all 0.2s}
        ...
        .comment-author{font-size:0.8rem;font-weight:600;color:#1A1A1A;text-decoration:none}
        .comment-author:hover{color:#F47B20}
        .comment-time{font-size:0.65rem;color:#A3A3A3}
        .delete-comment{background:none;border:none;color:#A3A3A3;cursor:pointer;font-size:0.78rem;margin-left:auto}
        ...
        .reply-author{font-size:0.75rem;font-weight:600;color:#1A1A1A;text-decoration:none}
        .reply-author:hover{color:#F47B20}
        .reply-text{font-size:0.78rem;color:#525252}
        .reply-btn{background:none;border:none;color:#A3A3A3;cursor:pointer;font-size:0.72rem;font-family:var(--font-body);padding:0;margin-top:0.25rem}
        ...
        @media(max-width:640px){
          ...
          /* CRITICAL: fixed height on mobile so images NEVER push content off-screen */
          ...
          .img-arrow{width:30px;height:30px;font-size:1.1rem}
        }
      `}</style>
    </div>
  );
