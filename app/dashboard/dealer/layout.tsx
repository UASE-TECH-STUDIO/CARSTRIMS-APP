  ...
  return (
    <div className="dealer-shell">
      ...
      <div className="dealer-main">
        ...
        {isPending && (
          <div style={{background:"#FFF7ED",borderBottom:"2px solid #F47B20",padding:"0.6rem 1.75rem",fontSize:"0.82rem",color:"#C4621A",display:"flex",alignItems:"center",gap:"0.75rem",flexWrap:"wrap",flexShrink:0}}>
            <span>⏳</span>
            <span><strong>Pending Approval:</strong> Your account is under review. Your listings are hidden from buyers until the super admin approves your account. You can still add cars, manage staff, and set up your dashboard.</span>
          </div>
        )}
      ...
      <style>{`
        ...
        .sidebar-overlay{position:fixed;inset:0;background:rgba(0,0,0,0.45);z-index:55;cursor:pointer}
