...
/**
 * Design Studio (Marketing Materials) - muted per request, not
 * deleted. See id-cards/page.tsx for the full explanation - same
 * situation here. Full implementation preserved at
 * page.tsx.bak-designstudio.
 */
export default function MarketingMuted() {
  return (
