        ...
        <div className="header-btns">
          <div style={{position:"relative",display:"inline-block"}}>
            ...
            {showSalesPicker==="download" && (
              <div style={{position:"absolute",top:"calc(100% + 4px)",right:0,zIndex:30,background:"#fff",border:"1px solid #E5E5E5",borderRadius:"8px",boxShadow:"0 6px 18px rgba(0,0,0,0.15)",overflow:"hidden",minWidth:"110px",maxWidth:"calc(100vw - 2rem)"}}>
