        ...
        <div className="cp-header">
          ...
          <div className="cp-btns">
            <div style={{position:"relative"}}>
              ...
              {showExportPicker && (
                <div style={{position:"absolute",top:"calc(100% + 6px)",right:0,zIndex:30,background:"#fff",border:"1.5px solid #E5E5E5",borderRadius:"10px",boxShadow:"0 8px 24px rgba(0,0,0,0.15)",overflow:"hidden",minWidth:"150px"}}>
