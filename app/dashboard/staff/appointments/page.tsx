...
const Inner = dynamic(() => import("@/app/dashboard/dealer/appointments/page"), {
  ssr: false,
  loading: () => <div style={{padding:"2rem",color:"#737373"}}>Loading Appointments...</div>
});
...
export default function StaffAppointmentsPage() {
  ...
  if (!allowed) return (
    <div style={{padding:"3rem",textAlign:"center",background:"#fff",border:"1.5px solid #E5E5E5",borderRadius:"12px"}}>
      ...
      <p style={{color:"#737373",marginTop:"0.5rem",fontSize:"0.875rem"}}>You do not have permission to access Appointments.</p>
    </div>
  );
  return <Inner />;
}
