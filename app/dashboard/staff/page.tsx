...
const PERM_LABELS: Record<string,string> = {
  ...
  view_requests:"View Requests",     manage_requests:"Manage Requests",
  view_expenses:"View Expenses",     manage_expenses:"Manage Expenses",
  view_movements:"View Movements",   manage_movements:"Log Movements",
  view_partners:"View Partners",     manage_partners:"Manage Partners",
  view_messages:"View Messages",     send_messages:"Reply to Messages",
  view_cctv:"View CCTV",
  view_staff:"View Staff",           create_staff:"Create Staff",
  edit_staff:"Edit Staff",           suspend_staff:"Suspend Staff",
};

const PERM_ROUTES: Record<string,string> = {
  view_inventory:"/dashboard/staff/inventory",   add_cars:"/dashboard/staff/inventory",
  edit_cars:"/dashboard/staff/inventory",        delete_cars:"/dashboard/staff/inventory",
  view_sales:"/dashboard/staff/sales",           record_sales:"/dashboard/staff/sales",
  view_invoices:"/dashboard/staff/sales",        generate_invoices:"/dashboard/staff/sales",
  edit_documents:"/dashboard/staff/sales",
  view_reports:"/dashboard/staff/reports",       generate_reports:"/dashboard/staff/reports",
  view_appointments:"/dashboard/staff/appointments", manage_appointments:"/dashboard/staff/appointments",
  view_requests:"/dashboard/staff/requests",     manage_requests:"/dashboard/staff/requests",
  view_expenses:"/dashboard/staff/expenses",     manage_expenses:"/dashboard/staff/expenses",
  view_movements:"/dashboard/staff/movements",   manage_movements:"/dashboard/staff/movements",
  view_partners:"/dashboard/staff/partners",     manage_partners:"/dashboard/staff/partners",
  view_messages:"/dashboard/staff/messages",     send_messages:"/dashboard/staff/messages",
  view_cctv:"/dashboard/staff/cctv",
  view_staff:"/dashboard/staff/staff",           create_staff:"/dashboard/staff/staff",
  edit_staff:"/dashboard/staff/staff",           suspend_staff:"/dashboard/staff/staff",
};
