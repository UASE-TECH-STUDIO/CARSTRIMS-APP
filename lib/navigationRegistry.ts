...
const ENTRIES: NavEntry[] = [
  ...
  { path: "/dashboard/dealer/business-docs", label: "Business Documents", description: "Generate letterheads, proforma invoices, and receipts", keywords: ["letterhead", "letter head", "proforma", "proforma invoice", "receipt", "generate receipt", "generate invoice", "business document", "quote", "quotation"], roles: ["dealer"] },
  { path: "/dashboard/dealer/marketing", label: "Marketing Materials", description: "Generate flyers and complimentary cards for vehicles and the business", keywords: ["flyer", "poster", "complimentary card", "compliment card", "business card", "marketing", "car flyer", "vehicle flyer", "promote car", "advertise"], roles: ["dealer"] },
  ...
  { path: "/dashboard/staff/business-docs", label: "Business Documents", description: "Generate letterheads, proforma invoices, and receipts (needs generate_business_docs permission)", keywords: ["letterhead", "letter head", "proforma", "proforma invoice", "receipt", "generate receipt", "generate invoice", "business document", "quote", "quotation"], roles: ["staff"] },
  { path: "/dashboard/staff/marketing", label: "Marketing Materials", description: "Generate flyers and complimentary cards (needs generate_marketing_materials permission)", keywords: ["flyer", "poster", "complimentary card", "compliment card", "business card", "marketing", "car flyer", "vehicle flyer", "promote car", "advertise"], roles: ["staff"] },
